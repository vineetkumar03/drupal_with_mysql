 ...
 *
 */
$drupal_hash_salt = 'MLeDeLlIgDBn5ne4NolBZajQ_O_MO10Zx4K31vQE3MA';

$base_url = getenv('SITE_URL');

$_SERVER['HTTPS']=getenv('IS_HTTPS');
 ...
 */
$conf['reverse_proxy_addresses'] = array('192.168.8.0', 'localhost', '127.0.0.1');
